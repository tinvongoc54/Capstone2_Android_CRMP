...
import tweather.framgia.com.crimeandmissingreport.Adapter.MissingPersonViewPagerAdapter;
...
public class MissingPersonFragment extends Fragment {
    ...
    public void initView(View view) {
        ...
        mViewPager.setAdapter(new MissingPersonViewPagerAdapter(getFragmentManager()));
