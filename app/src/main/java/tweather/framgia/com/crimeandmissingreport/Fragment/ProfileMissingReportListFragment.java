...
public class ProfileMissingReportListFragment extends Fragment {
    ...
    public void onStart() {
        super.onStart();
        ProfileFragment.checkFragment = false;
    }
    ...
    private void getReportList() {
        Call<List<Report>> callList = APIUtils.getData(APIUtils.BASE_URL)
                .GetMissingReportListOfUser(
                        APIUtils.API_UPDATE_USER_URL + ProfileFragment.mSharedPreferences.getInt(
                                LoginDialog.SHAREDPREFERENCES_ID_USER, 10000) + "/missings");
